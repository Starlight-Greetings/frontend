    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in select-none">
      <div className="w-full max-w-sm glass-panel rounded-3xl p-6 border border-cyan-400/40 shadow-[0_0_40px_rgba(6,182,212,0.25)] animate-modal-in flex flex-col space-y-4 text-center relative overflow-hidden">
        ...
        <div className="space-y-2">
          <div className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-cyan-950/80 border border-cyan-400/30 text-cyan-300 text-[11px] font-medium whitespace-nowrap">
            <Sparkles className="w-3 h-3 text-cyan-300 shrink-0" />
            <span>도림천 이용 소감 조사</span>
          </div>

          <h3 className="text-base font-bold text-white tracking-tight leading-snug break-keep">
            따뜻한 편지가 전달되었습니다!<br />
          ...
          <p className="text-xs text-slate-300/80 leading-relaxed font-light px-2 break-keep">
            소중한 의견(약 1분 소요)은 별빛내린천 공간 개선과 서비스 향상에 큰 힘이 됩니다.
          </p>
        </div>

        <div className="px-3 py-2 rounded-xl bg-cyan-500/10 border border-cyan-400/20 text-[10px] text-cyan-200/80 break-keep">
        ...
        <div className="pt-2 space-y-2">
          ...
          >
            <span className="whitespace-nowrap">네, 설문 참여할게요 (네이버 폼)</span>
